      ...
      <div className="flex md:flex-row flex-col min-h-screen md:ml-10 mx-auto md:mx-0">
        <div className="w-full md:max-w-2xl  px-4">
          ...
          <div className="relative group inline-block w-full mt-4">
            ...
            {outlets.length === 0 && (
              <div className="w-[10vw] absolute -top-10 left-1/2 translate-x-1/2 bg-gray-800 text-white text-sm px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity z-10 pointer-events-none">
                You at least have to add one outlet to save
              </div>
            )}
          </div>
        </div>
        ...
        <div className="flex flex-col md:items-center mt-8 space-y-6 w-full m-4">
              ...
              {outlets.map((outlet: any, index: number) => (
                <div
                  ...
                  <Trash
                    ...
                    onClick={() => remove(index)} // 🆕 Add remove handler
                  />
                </div>
              ))}
            </div>
