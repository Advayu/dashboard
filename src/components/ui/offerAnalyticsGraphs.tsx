...
const OfferAnalyticsGraph: React.FC<GraphsProps> = ({ dataset}) => {
        ...
        yAxis={[
          {
            ...
            min: 10000, // Minimum value for the Y-axis
            max: 60000, // Maximum value for the Y-axis
          },
        ]}
...
export default OfferAnalyticsGraph; 